...
**"자취생의 식비 절약과 효율적인 스마트 냉장고 파먹기!"**

혼자 사는 자취생들은 식재료를 사두고도 유통기한을 놓쳐 버리거나, 남은 재료로 어떤 요리를 해야 할지 몰라 배달 음식을 시키며 식비를 낭비하는 경우가 많습니다. 이 프로젝트는 이러한 고민을 해결하기 위해 기획되었습니다. 

사용자가 나의 냉장고 속에 있는 식재료들(구매 일자, 유통기한 등)을 입력해 두면, **AI가 알아서 남은 재료들을 분석해 만들 수 있는 간단한 요리나 식단표를 짜주고 구체적인 레시피까지 제공**해 줍니다. 버려지는 식재료를 줄이고 알뜰하게 식비를 절약할 수 있도록 돕는 똑똑한 자취 필수 앱입니다!
